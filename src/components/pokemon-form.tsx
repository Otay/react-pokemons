...
const PokemonForm: FunctionComponent<Props> = ({pokemon, isEditForm}) => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();//on bloque le comportement natif du from pour faire la soumission nous meme
        ...
        <div className="col s12 m8 offset-m2">
          <div className="card hoverable">
            ...
            <div className="card-image">
              ...
              <span className="btn-floating halfway-fab waves-effect waves-Ligth">
                  ...
                  {types.map(type => (
                    <div key={type} style={{marginBottom: '10px'}}>
                      <label>
                        ...
                        value={type} checked={hasType(type)} onChange={e => selectType(type, e)}></input>
                        <span>
